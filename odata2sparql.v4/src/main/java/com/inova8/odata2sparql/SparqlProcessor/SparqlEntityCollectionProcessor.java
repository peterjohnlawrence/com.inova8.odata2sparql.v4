...
/**
 * The Class SparqlEntityCollectionProcessor.
 */
public class SparqlEntityCollectionProcessor{/** The Constant log. */
// implements CountEntityCollectionProcessor {
	...
	/**
	 * Instantiates a new sparql entity collection processor.
	 *
...
//	}
	...
	/**
 * Process entity collection query.
 *
...
public static void processEntityCollectionQuery(ServiceMetadata serviceMetadata,OData odata,RdfEdmProvider rdfEdmProvider,ODataRequest request, ODataResponse response, UriInfo uriInfo,
	...
	/**
	 * Sort entity collection.
	 *
	 * @param entitySet the entity set
	 * @param orderByOption the order by option
	 */
